...
public class WorkloadUtilsTest {
        ...
        private static final TopologySpreadConstraint DEFAULT_TOPOLOGY_SPREAD_CONSTRAINT = new TopologySpreadConstraintBuilder()
                        ...
                        .withLabelSelector(new LabelSelectorBuilder().withMatchLabels(singletonMap("label", "value"))
                                        .build())
                        .build();
        ...
        public void testCreateDeploymentWithNullTemplateAndRecreateStrategy() {
                Deployment dep = WorkloadUtils.createDeployment(
                                ...
                                WorkloadUtils.deploymentStrategy(
                                                io.strimzi.api.kafka.model.common.template.DeploymentStrategy.RECREATE),
                ...
                assertThat(dep.getSpec().getSelector().getMatchLabels().get(Labels.STRIMZI_CLUSTER_LABEL),
                                is("my-cluster"));
                assertThat(dep.getSpec().getSelector().getMatchLabels().get(Labels.STRIMZI_NAME_LABEL),
                                is("my-workload"));
        ...
        public void testCreateDeploymentWithTemplateAndRollingUpdateStrategy() {
                Deployment dep = WorkloadUtils.createDeployment(
                                ...
                                Map.of("extra", "annotations"),
                                WorkloadUtils.deploymentStrategy(
                                                io.strimzi.api.kafka.model.common.template.DeploymentStrategy.ROLLING_UPDATE),
                                DUMMY_POD_TEMPLATE_SPEC);

                assertThat(dep.getMetadata().getName(), is(NAME));
                assertThat(dep.getMetadata().getNamespace(), is(NAMESPACE));
                assertThat(dep.getMetadata().getOwnerReferences(), is(List.of(OWNER_REFERENCE)));
                assertThat(dep.getMetadata().getLabels(), is(LABELS
                                .withAdditionalLabels(Map.of("label-3", "value-3", "label-4", "value-4")).toMap()));
                assertThat(dep.getMetadata().getAnnotations(),
                                is(Map.of("extra", "annotations", "anno-1", "value-1", "anno-2", "value-2")));
        ...
        public void testCreateStrimziPodSetWithNullTemplate() {
                ...
                assertThat(sps.getSpec().getSelector().getMatchLabels().get(Labels.STRIMZI_CLUSTER_LABEL),
                                is("my-cluster"));
                assertThat(sps.getSpec().getSelector().getMatchLabels().get(Labels.STRIMZI_NAME_LABEL),
                                is("my-workload"));
                ...
                assertThat(sps.getSpec().getPods().stream()
                                .map(pod -> PodSetUtils.mapToPod(pod).getMetadata().getName()).toList(),
                                is(List.of("my-workload-0", "my-workload-1", "my-workload-2", "my-workload-3",
                                                "my-workload-4")));
        }
        ...
        public void testCreateStrimziPodSetWithTemplate() {
                ...
                assertThat(sps.getMetadata().getNamespace(), is(NAMESPACE));
                assertThat(sps.getMetadata().getOwnerReferences(), is(List.of(OWNER_REFERENCE)));
                assertThat(sps.getMetadata().getLabels(), is(LABELS
                                .withAdditionalLabels(Map.of("label-3", "value-3", "label-4", "value-4")).toMap()));
                assertThat(sps.getMetadata().getAnnotations(),
                                is(Map.of("extra", "annotations", "anno-1", "value-1", "anno-2", "value-2")));
        ...
        public void testCreateStrimziPodSetFromNodeReferencesWithNullTemplate() {
                ...
                assertThat(sps.getSpec().getPods().stream()
                                .map(pod -> PodSetUtils.mapToPod(pod).getMetadata().getName()).toList(),
                                hasItems("my-cluster-nodes-10", "my-cluster-nodes-11", "my-cluster-nodes-12"));
        }
        ...
        public void testCreateStatefulPodWithNullValues() {
                ...
                assertThat(pod.getMetadata().getAnnotations(),
                                is(Map.of(PodRevision.STRIMZI_REVISION_ANNOTATION, "6a6a679b")));
        ...
        public void testCreateStatefulPodWithNullValuesAndNullTemplate() {
                ...
                assertThat(pod.getMetadata().getLabels(), is(LABELS
                                ...
                                .toMap()));
                assertThat(pod.getMetadata().getAnnotations(), is(
                                Map.of("extra", "annotations", PodRevision.STRIMZI_REVISION_ANNOTATION, "da09ff49")));
                ...
                assertThat(pod.getSpec().getVolumes(),
                                is(VolumeUtils.createPodSetVolumes(NAME + "-0", DEFAULT_STORAGE, false)));
                assertThat(pod.getSpec().getTolerations(), is(nullValue()));
                assertThat(pod.getSpec().getTerminationGracePeriodSeconds(), is(30L));
                assertThat(pod.getSpec().getImagePullSecrets(),
                                is(List.of(new LocalObjectReference("some-pull-secret"))));
        ...
        public void testCreateStatefulPodWithTemplate() {
                Pod pod = WorkloadUtils.createStatefulPod(
                                ...
                                new PodTemplateBuilder()
                                                ...
                                                .withImagePullSecrets(List
                                                                .of(new LocalObjectReference("some-other-pull-secret")))
                                                ...
                                                .withSecurityContext(new PodSecurityContextBuilder().withRunAsUser(0L)
                ...
                assertThat(pod.getMetadata().getLabels(), is(LABELS
                                ...
                                .withStrimziPodName(NAME + "-0")
                                .withAdditionalLabels(Map.of("statefulset.kubernetes.io/pod-name", "my-workload-0",
                                                "default-label", "default-value", "label-3", "value-3", "label-4",
                                                "value-4"))
                                .toMap()));
                assertThat(pod.getMetadata().getAnnotations(), is(Map.of("extra", "annotations", "anno-1", "value-1",
                                "anno-2", "value-2", PodRevision.STRIMZI_REVISION_ANNOTATION, "4c2e5618")));
                ...
                assertThat(pod.getSpec().getImagePullSecrets(),
                                is(List.of(new LocalObjectReference("some-other-pull-secret"))));
                assertThat(pod.getSpec().getSecurityContext(), is(DEFAULT_POD_SECURITY_CONTEXT));
                ...
                assertThat(pod.getSpec().getTopologySpreadConstraints(),
                                is(List.of(DEFAULT_TOPOLOGY_SPREAD_CONSTRAINT)));
        }
        ...
        public void testCreatePodTemplateSpecWithNullTemplate() {
                ...
                assertThat(pod.getMetadata().getLabels(),
                                is(LABELS.withAdditionalLabels(Map.of("default-label", "default-value")).toMap()));
        ...
        public void testCreatePodTemplateSpecWithTemplate() {
                ...
                assertThat(pod.getMetadata().getLabels(), is(LABELS.withAdditionalLabels(
                                Map.of("default-label", "default-value", "label-3", "value-3", "label-4", "value-4"))
                                .toMap()));
                assertThat(pod.getMetadata().getAnnotations(),
                                is(Map.of("extra", "annotations", "anno-1", "value-1", "anno-2", "value-2")));
        ...
        public void testRemoveEmptyValuesFromTolerations() {
                ...
                assertThat(WorkloadUtils.removeEmptyValuesFromTolerations(List.of(t1)),
                                is(WorkloadUtils.removeEmptyValuesFromTolerations(List.of(t2))));
        }

        @Test
        public void testImagePullSecrets() {
                List<LocalObjectReference> defaults = List
                                .of(new LocalObjectReferenceBuilder().withName("default").build());
                List<LocalObjectReference> custom = List
                                .of(new LocalObjectReferenceBuilder().withName("custom").build());
                ...
                assertThat(WorkloadUtils.imagePullSecrets(new PodTemplateBuilder().withImagePullSecrets(custom).build(),
                                defaults), is(custom));
        }

        @Test
        public void testDeploymentStrategyRecreate() {
                DeploymentStrategy strategy = WorkloadUtils.deploymentStrategy(
                                io.strimzi.api.kafka.model.common.template.DeploymentStrategy.RECREATE);
